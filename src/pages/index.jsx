...
export default () =>
    <div className="content__wrapper">
        ...
        <article className="u-section-sm u-container u-center">
            ...
            <ul>
                <li>Organic 8-bit freegan cold-pressed marfa.</li>
                <li>Selfies tbh jianbing, cloud bread woke listicle master cleanse.</li>
                <li>PBR&B vice kale chips kitsch trust fund blue bottle.</li>
            </ul>
            <h3>Williamsburg sartorial occupy roof party swag.</h3>
            <p>Ugh distillery pug kickstarter sartorial raw denim, freegan synth tote bag YOLO woke poke. Tacos raclette messenger bag cloud bread ugh PBR&B. Cardigan tofu kinfolk, vegan post-ironic af shaman tbh salvia brooklyn. Disrupt messenger bag kombucha blog, cred shabby chic cold-pressed put a bird on it helvetica church-key before they sold out beard vexillologist. Humblebrag cronut twee fam woke you probably haven't heard of them bushwick cred mustache vinyl.</p>
            <p>Truffaut sartorial gochujang cardigan. Gochujang cloud bread hoodie, ethical post-ironic forage selvage yr subway tile roof party actually. Knausgaard activated charcoal +1 air plant poke meggings shoreditch cornhole. Tote bag etsy put a bird on it 90's, poke YOLO keffiyeh la croix cardigan. Ethical palo santo messenger bag direct trade, butcher trust fund paleo tbh hashtag street art vegan unicorn kitsch poke. Tumblr blue bottle yuccie, woke four dollar toast tilde hexagon salvia godard art party.</p>
        </article>
    </div>
